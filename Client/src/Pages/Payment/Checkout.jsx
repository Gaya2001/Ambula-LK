...
const CheckoutPage = () => {
  ...
  return (
    <div className="min-h-screen py-8 md:py-12 bg-[#0C1A39] text-white">
      <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div className="mb-10 text-center">
          <h1 className="text-3xl font-bold text-orange-500 md:text-4xl">Complete Your Order</h1>
          <p className="max-w-2xl mx-auto mt-3 text-gray-300">Please provide your information to finalize your purchase</p>
        </div>
  
        {success && (
          <div className="max-w-3xl mx-auto mb-8">
            <div className="flex items-center p-4 bg-green-900 border border-green-500 rounded-lg bg-opacity-40">
        ...
        <div className="flex flex-col gap-8 mx-auto lg:flex-row max-w-7xl">
          ...
          <div className="w-full lg:w-2/3">
            <form onSubmit={handleSubmit} className="space-y-6">
              {/* Customer Details */}
              <div className="overflow-hidden border border-gray-700 rounded-xl shadow-lg bg-[#162345]">
                <div className="px-6 py-4 border-b border-gray-700 bg-[#111C36]">
                  <h2 className="flex items-center text-xl font-semibold text-orange-400">
                  ...
                  <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full p-3 transition duration-150 border border-gray-600 rounded-lg text-white bg-[#0C1A39] focus:ring-2 focus:ring-orange-500 focus:border-orange-500 focus:outline-none"
                        required
              ...
              <div className="overflow-hidden border border-gray-700 rounded-xl shadow-lg bg-[#162345]">
                ...
                <div className="p-6">
                  <div className="mb-6">
                    <label htmlFor="address" className="block mb-2 text-sm font-medium text-gray-300">Street Address *</label>
                    <input
                      type="text"
                      id="address"
                      name="address"
                  ...
                  <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
                    ...
                    <div>
                      <label htmlFor="country" className="block mb-2 text-sm font-medium text-gray-300">Country</label>
                      <select
                        id="country"
                        name="country"
                    ...
                    <div>
                      <label htmlFor="postalCode" className="block mb-2 text-sm font-medium text-gray-300">Postal Code</label>
                      <input
                        type="text"
                        id="postalCode"
                        name="postalCode"
              ...
              {process.env.NODE_ENV !== 'production' && (
                <div className="overflow-hidden border border-gray-700 rounded-xl shadow-lg bg-[#162345]">
                  ...
                  <div className="p-6">
                    <div className="p-4 mb-6 bg-blue-900 border-l-4 border-blue-500 bg-opacity-20 rounded-r-md">
                      <div className="flex">
                    ...
                    <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
                      <div className="p-4 transition-all duration-200 border border-gray-700 rounded-lg shadow-lg bg-[#111C36] hover:shadow-xl hover:border-orange-500">
                        <div className="flex items-center mb-2">
                          ...
                          <span className="font-semibold text-blue-300">Visa</span>
                        </div>
                        <p className="p-2 font-mono text-sm text-gray-300 border border-gray-700 rounded bg-[#0C1A39]">4916217501611292</p>
                      </div>
                      <div className="p-4 transition-all duration-200 border border-gray-700 rounded-lg shadow-lg bg-[#111C36] hover:shadow-xl hover:border-orange-500">
                        <div className="flex items-center mb-2">
                          <svg className="w-6 h-6 mr-2 text-red-400" viewBox="0 0 24 24" fill="currentColor">
                          ...
                          <span className="font-semibold text-red-300">MasterCard</span>
                        </div>
                        <p className="p-2 font-mono text-sm text-gray-300 border border-gray-700 rounded bg-[#0C1A39]">5307732125531191</p>
                      </div>
                      <div className="p-4 transition-all duration-200 border border-gray-700 rounded-lg shadow-lg bg-[#111C36] hover:shadow-xl hover:border-orange-500">
                        <div className="flex items-center mb-2">
                          <svg className="w-6 h-6 mr-2 text-blue-300" viewBox="0 0 24 24" fill="currentColor">
                          ...
                          <span className="font-semibold text-blue-300">AMEX</span>
                        </div>
                        <p className="p-2 font-mono text-sm text-gray-300 border border-gray-700 rounded bg-[#0C1A39]">346781005510225</p>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              {error && (
                <div className="p-4 bg-red-900 border border-red-500 rounded-lg bg-opacity-30" data-testid="error-message">
                  <div className="flex">
                    <div className="flex-shrink-0">
          ...
          <div className="w-full mt-8 lg:w-1/3 lg:mt-0">
            {orderDetails && (
              <div className="sticky overflow-hidden border border-gray-700 rounded-xl shadow-lg top-8 bg-[#162345]">
                <div className="px-6 py-4 border-b border-gray-700 bg-[#111C36]">
                  <h2 className="flex items-center text-xl font-semibold text-orange-400">
                    <svg className="w-5 h-5 mr-2 text-orange-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <div className="p-6">
                  <div className="pr-2 mb-6 -mr-2 space-y-3 overflow-auto max-h-64 custom-scrollbar" data-testid="order-items">
                    {orderDetails.items.map((item, index) => (
                      <div key={index} className="flex items-center justify-between py-3 border-b border-gray-700">
                        <div className="flex items-start">
                          <div className="flex items-center justify-center w-6 h-6 mr-3 text-xs font-medium text-white bg-orange-600 rounded-full">
                            {item.quantity}
                          </div>
                          <div>
                            <h4 className="font-medium text-white">{item.name || `Item #${item.menuItemId}`}</h4>
                            <p className="text-sm text-gray-400">LKR {item.price.toFixed(2)} each</p>
                          </div>
                        </div>
                        <span className="font-medium text-orange-400">LKR {(item.price * item.quantity).toFixed(2)}</span>
                      </div>
                    ))}
                  </div>
  
                  <div className="pt-4 mt-2 space-y-3 border-t border-gray-700">
                    ...
                    <div className="flex justify-between pt-4 mt-2 text-lg font-bold border-t border-gray-700">
                      <span className="text-white">Total</span>
                      <span className="text-orange-400">LKR {(orderDetails.totalAmount).toFixed(2)}</span>
                    </div>
                  </div>
                  ...
                  <div className="flex flex-col gap-4 mt-6">
                    <button
                      ...
                      className="flex items-center justify-center w-full px-6 py-3 font-medium text-white transition duration-200 bg-orange-500 rounded-lg shadow-md hover:bg-orange-600 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:ring-opacity-50"
                      disabled={isLoading}
                    ...
                    <button
                      ...
                      className="flex items-center justify-center w-full px-6 py-3 font-medium text-gray-300 transition duration-200 bg-transparent border border-gray-600 rounded-lg hover:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-opacity-50"
                  ...
                  <div className="p-4 mt-6 border border-gray-700 rounded-lg bg-[#111C36]">
                    <div className="flex items-center justify-center space-x-2">
                      <svg className="w-5 h-5 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z" />
                      </svg>
                      <span className="text-sm text-gray-400">Secure payment via PayHere</span>
                    </div>
                  </div>
                </div>
              </div>
