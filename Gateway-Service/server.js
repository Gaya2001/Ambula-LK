...
const AUTH_SERVICE = 'http://auth-service:5001'; // Authentication
const RESTAURANT_SERVICE = 'http://restaurant-service:5002'; // Restaurant management
const ORDER_SERVICE = 'http://order-service:5003'; // Order management
const DELIVERY_SERVICE = 'http://delivery-service:5004'; // Delivery service
const PAYMENT_SERVICE = 'http://payment-service:5005'; // Payment service
